...
    else:
        st.info("Suggerimento: Carica un video registrato lateralmente per attivare l'estrazione dello scheletro, i grafici di analisi biomeccanica e la predizione clinica basata su Machine Learning.")  NELLA MIA APP VOGLIO CHE METTI IMMAGINI DI QUESTO TIPO SPORT TECH FUTURISCHE ASTRATTE E NON CON CONTORNI DEFINITI MA SFUMATI DAMM IL CODICE COMPLETO
